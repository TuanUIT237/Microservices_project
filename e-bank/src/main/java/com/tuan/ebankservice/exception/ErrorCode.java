...
public enum ErrorCode {
    ...
    AMOUNT_LOAN_INVALID(1504,"Amount must be equal or greater than monthly installment amount",HttpStatus.BAD_REQUEST),
    ...
    MIN_DAY_OF_CUTOFF_INVALID(1512,"The minimum value of the date must be equal or greater than {value}",HttpStatus.BAD_REQUEST),
    MAX_DAY_OF_CUTOFF_INVALID(1513,"The maximum value of the date must be less or equal than {value}",HttpStatus.BAD_REQUEST),
    ...
    BETWEEN_START_AND_END_DATE_INVALID(1526,"The distance between the start and end dates is less than 30",HttpStatus.BAD_REQUEST),
    ...
    DESTINATION_ACCOUNT_NUMBER_NOT_NULL(1537,"Destination account number cannot be left blank",HttpStatus.BAD_REQUEST),
    ...
    SOURCE_AND_DESTINATION_ARE_SIMILAR(1540,"The source account and the destination account cannot be the same",HttpStatus.BAD_REQUEST),
